...
              <span class="block text-4xl mb-4 text-[#FFD700]">💉</span>
...
              <span class="block text-4xl mb-4 text-[#FFD700]">👩⚕️</span>
...
              <span class="ml-4 text-3xl text-[#FFD700]">👨⚕️</span>
              <span class="luxury-accent persian-text text-lg text-white">دکتر احمدی - پوست و زیبایی</span>
            </button>
...
              <span class="ml-4 text-3xl text-[#FFD700]">👩⚕️</span>
              <span class="luxury-accent persian-text text-lg text-white">دکتر محمدی - جراحی زیبایی</span>
            </button>
          </div>
        </div>
